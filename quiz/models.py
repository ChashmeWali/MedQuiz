...
class Quiz(models.Model):
    ...
    def import_quiz_from_excel(self):
        ...
        for index, row in df.iterrows():
            ...
            choice_1, created = Choice.objects.get_or_create(question=question, text=choice1, is_correct=correct_answer == 'A')
            choice_2, created = Choice.objects.get_or_create(question=question, text=choice2, is_correct=correct_answer == 'B')
            choice_3, created = Choice.objects.get_or_create(question=question, text=choice3, is_correct=correct_answer == 'C')
            choice_4, created = Choice.objects.get_or_create(question=question, text=choice4, is_correct=correct_answer == 'D')
